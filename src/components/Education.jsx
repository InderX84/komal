...
const timeline = [
  {
    ...
    desc: 'Successfully completed secondary education while developing strong academic values and discipline.',
    icon: '🏫',
  ...
  },
  {
    ...
    desc: 'Completed higher secondary education and strengthened the foundation for future academic and professional goals.',
    icon: '📚',
  ...
  },
  {
    ...
    location: 'Rajpura',
    desc: 'Preparing to pursue higher education in commerce and develop knowledge in finance, economics, business, and management.',
    icon: '🎓',
...
export default function Education() {
  ...
  return (
    <section id="education" className="py-16 sm:py-24 bg-gradient-to-br from-slate-50 to-purple-50 dark:from-slate-800 dark:to-slate-900 relative overflow-hidden">
      ...
      <div ref={ref} className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="relative">
          ...
          <div className="absolute left-5 top-0 bottom-0 w-0.5 bg-gradient-to-b from-primary-500 via-pink-500 to-gold-500" />
